...
// build mesh data structure
    ...
    if(nLandmarks!=0) landmarks_2d[0] = 0;
	...
	for (int i=0; i<nContour; ++i)
	{
		...
		for (int j=0; j<nVertices; ++j)
			all_energies[getIndex(j, i, nVertices)] = pairwise_energy(vertices, nVertices, dimVertices, contour, nContour, dimContour, i, j,  landmarks_2d, landmarks_3d, nLandmarks);
	}
	...
	{   
        ...
        std::cout << "Front: " << pathFront << ", Back: " << pathBack << std::endl;
